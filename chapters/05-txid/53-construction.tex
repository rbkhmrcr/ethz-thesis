...
is exactly the expense the instantiation avoids. Second, $\FT$ is parameterised
...
$\PTK$, $\G$ and $\G'$ are one way, and the zero-knowledge proof systems for $\rel_4$ through $\rel_7$
