...
ATLAS builds on the protocol of~\cite{C:DamNie07}, improving its
...
of~\cite{C:DamNie07}, letting parties use one round of
...
MASCOT~\cite{CCS:KelOrsSch16} performs authenticated secure multiplication
...
MP-SPDZ~\cite{CCS:Keller20}, a framework for implementing MPC with
...
implemented in prior work~\cite{ESORICS:DOKSS20,Ghosh2023}.
...
Table~\ref{table:comp} compares our two schemes against~\cite{AC:CKPSS23}
and~\cite{PKC:MMSST24} in terms of assumptions, message space, key and
