...
all operations to take place over pairing-friendly curves. This was also considered by Ghosh et al., who integrate the RELIC toolkit
into MP-SPDZ for operations over pairing-friendly curves, and extend MP-SPDZ
with shared computation over elements of the resulting elliptic curve
groups~\cite{Ghosh2023,relictoolkit}.
