...
Section~\ref{sec:tsps-definitions}. A partially non-interactive scheme is one whose
...
our constructions from Section~\ref{sec:tsps-instantiation} fall into this class.
...
\paragraph{Proof.}
  ...
  corresponding public key shares, consistent with the sharing $\lbrack \pk\rbrack $ of
  $\pk$. It forwards $\pk$, $\{\sk_i\}_{i \in \Cor}$, and $\lbrack \pk\rbrack $ to $\adv$.
