...
We take inspiration from threshold signature security definitions that
introduce a hierarchy of increasingly strong notions of unforgeability for
fully and partially non-interactive threshold signature
schemes~\cite{C:BCKMTZ22}. A partially non-interactive scheme is one whose
