...
win with message-signature pair $(\vec{{M}^*}, \signature^*)$ if the partial
...
\paragraph{Proof.}
  ...
  $\SPSverify$. In both cases, $\advB$ can respond to every query of $\adv$
  ...
  itself, if $\adv$ outputs a forgery $(\vec{{M}^*}, \signature^*)$ satisfying
  the winning condition of the adp-TS-UF-1 game, then $(\vec{{M}^*},
  \signature^*)$ also satisfies the winning condition of the wUF-CMA game for
