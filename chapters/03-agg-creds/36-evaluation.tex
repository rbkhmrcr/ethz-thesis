...
pairing-friendly groups. The scheme is instantiatied using the
...
\begin{figure}[h] \centering \includegraphics[width=1\textwidth]{chapters/03-agg-creds/vary_n_big.pdf}
...
\begin{figure}[h] \centering \includegraphics[width=1\textwidth]{chapters/03-agg-creds/vary_k_big.pdf}
...
contrasts with credential systems such as Idemix~\cite{idemix}, where proving
