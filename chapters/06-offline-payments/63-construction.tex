...
\pk_{\algo{cb}})$.
	...
	\item Run $\ck \leftarrow \ComGen(\secparam)$ to obtain a public
...
(\algo{uid}_0, v_0, s_0), \psi) = 1 \;\wedge\; \ComOpen(\ck, \algo{uid}_0, s_0,
\com_0) = 1.  \end{equation*}
...
$\com_{i+1} \leftarrow \com(\ck, \algo{uid}_{i+1}; s_{i+1})$, and returns
...
\sk_{\algo{usr}_i}), \varphi_i) = 1 \;\wedge\; \ComOpen(\ck, \algo{uid}_i, s_i,
\com_i) = 1.  \end{equation*} Binding $\com_{i+1}$ into $m_i$ is what fixes the
